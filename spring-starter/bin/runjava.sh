...
if [[ -z $JAVA_CP ]]; then
    ...
    JAVA_CP="$JAVA_CP${CP_SEP}$PROJ_HOME_MIXED_PATH/hello-spring-common-service/target/classes"
    JAVA_CP="$JAVA_CP${CP_SEP}$PROJ_HOME_MIXED_PATH/hello-spring-common-service/target/dependency/*"
fi
